<?php
	...
	while($row = mysql_fetch_array($query)){
		...
		$path_original = "assets/img/original/04/".$file_original;
		...
		try {
			...
			if($row['Original_Width'] > $row['Original_Height']) :
				...
				if($row['Original_Width'] > 1024) : 
					...
					$path_large = "assets/img/large/04/".$file_large;
				...
				if($row['Original_Width'] > 2048) : 
					...
					$path_large2048 = "assets/img/large2048/04/".$file_large2048;
